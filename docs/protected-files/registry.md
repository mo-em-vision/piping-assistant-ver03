...
| Node / workflow authoring | Matching files under [`docs/node-templates/`](../node-templates/) |
...
- `docs/node-templates/assumption.md`
- `docs/node-templates/Authority Context.md`
- `docs/node-templates/Authority Node.md`
- `docs/node-templates/designation.md`
- `docs/node-templates/Dimension Node.md`
- `docs/node-templates/documentation.md`
- `docs/node-templates/embedded_source.md`
- `docs/node-templates/Engineering Concept.md`
- `docs/node-templates/equation node.md`
- `docs/node-templates/Execution Context.md`
- `docs/node-templates/Fact Node.md`
- `docs/node-templates/Goal Node.md`
- `docs/node-templates/interaction.md`
- `docs/node-templates/lookup.md`
- `docs/node-templates/Paragraph Node.md`
- `docs/node-templates/Parameter Node.md`
- `docs/node-templates/quantity.md`
- `docs/node-templates/Relationship Taxonomy.md`
- `docs/node-templates/standard_section.md`
- `docs/node-templates/Table Node.md`
- `docs/node-templates/text.md`
- `docs/node-templates/Unit Node.md`
- `docs/node-templates/validation_rule.md`
- `docs/node-templates/Workflow Node.md`

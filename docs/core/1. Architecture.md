...
> **Status:** STEP 0 scaffold locked. STEP 1 data models in `models/`. STEP 2 `TaskStateManager` implemented in `engine/state/`. All other engine modules remain empty stubs.

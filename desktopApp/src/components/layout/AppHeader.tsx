...
const DevToolsHeaderControls = env.devToolsAvailable

  ? lazy(async () => {

      const module = await import('./DevToolsHeaderControls')

      return { default: module.DevToolsHeaderControls }

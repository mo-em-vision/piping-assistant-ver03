---
equation_id: eq-7
name: Run Pipe Excess Thickness Area
...
variables:
  d_2:
    symbol: d_2
    description: Half width of reinforcement zone
    unit: mm
  d_1:
    symbol: d_1
  ...
  T_h:
    symbol: T_h
    description: Run pipe wall thickness
    unit: mm
  t_h:
    symbol: t_h
...
outputs:
  - symbol: A_2
    name: run_excess_thickness_area
    unit: mm2
    type: quantity
---
...
Area $A_2$ is the area resulting from excess thickness in the run pipe wall.
